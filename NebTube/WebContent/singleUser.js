 	...
 	$(document).ready(function(e) {
 		...
 		$.get('SingleUserServlet', {username:recievedUsername}, function(data) {
 			...
 			for(var i = 0;i<userFollowingName.length;i++){ 
 				...
 				//console.log(data.userFollowing.keys().indexOf(it));
 				//var followingProfilePicture = $('<img src="images/user"')
 				//replaceFunction();
 				//var followingProfilesRow = $('<div class="row" style="margin-top:2em;"></div>');
 		...
 		$(document).on('click', '.userChange', function(e) {
 			...
 			$(this).hide();
			//$('#'+changing+'.changeUserInput').focusout();
